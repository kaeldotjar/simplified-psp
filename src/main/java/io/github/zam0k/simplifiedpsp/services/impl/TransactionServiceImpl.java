...
public class TransactionServiceImpl implements TransactionService {
  ...
  private void authorizeTransaction() {
    ...
    try {
      response = restTemplate.getForEntity(externalAuthorizerServiceURL, String.class);
  ...
  private IPayee getPayee(TransactionDTO transaction) {
    ...
    return Stream.of(
            commonUserRepository.findById(payeeId), shopkeeperUserRepository.findById(payeeId))
